...
function TakeTurnState:victory()
    ...
    :finish(function()
        ...
        function()
            ...
            --exp = 100 -- use for quicker testing
            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        statsLevelUp = {hpIncrease, attackIncrease, defenseIncrease, speedIncrease}
                        ...
                        gStateStack:push(LevelUpMenuState(self.battleState, statsLevelUp))
                    else
                        self:fadeOutWhite()
                    end
                end)
