...
function BeginGameState:enter(def)
    ...
    while not self.board:checkPotentialMatches() do
...
function BeginGameState:render()
    ...
    -- self.board:render() --made this a comment to make a better effect (also because the board is initialized & rendered twice for level 1)
