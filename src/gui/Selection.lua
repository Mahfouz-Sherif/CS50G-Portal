...
function Selection:init(def)
    ...
    self.cursorFlag = def.cursorFlag and true -- boolean for toggling the cursor on and off for different menus
end
...
function Selection:render()
    ...
    for i = 1, #self.items do
        ...
        if i == self.currentSelection and self.cursorFlag  then
